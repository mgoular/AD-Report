...
function Get-DomainInfo($DomainName)
    ...
    Clear-Host
    Write-Host -ForegroundColor white -BackgroundColor black "Active Directory Report v1 by Michael Goulart"
    ...
    switch ($SchemaVersion.objectVersion)

        {
            ...
            87 { Write-Host -ForegroundColor Green $SchemaVersion.objectVersion "- Windows Server 2016 Operating system" }
